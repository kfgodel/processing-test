 ...
 */
public class IncrementingEllipses extends PApplet {

    private Random random;

    static public void main(String args[]) {
        PApplet.main(new String[]{IncrementingEllipses.class.getName()});
    }
    ...
    public void draw() {
        ...
        if(currentFps > 60){
            ...
            for (int i = 0; i < elementCount; i++) {
                ...
                float eliWidth = random(0, 100);
                float eliHeight = random(0, 100);
                ellipse(x, y, eliWidth, eliHeight);
            }
        ...
        rect(7,80,300,30);
        fill(255);
        text(String.format("FPS: %.3f, ellip: %d", currentFps, elementCount) ,10,100);
    }
}
