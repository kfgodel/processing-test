 ...
 */
public class IncrementingLines extends PApplet {

    private Random random;

    static public void main(String args[]) {
        PApplet.main(new String[]{IncrementingLines.class.getName()});
    }
    ...
    public void draw() {
        ...
        rect(7,80,300,30);
        fill(255);
        text(String.format("FPS: %.3f, lines: %d", currentFps, elementCount) ,10,100);
    }
}
