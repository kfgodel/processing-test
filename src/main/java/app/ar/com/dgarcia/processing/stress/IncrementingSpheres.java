 ...
 */
public class IncrementingSpheres extends PApplet {

    private Random random;

    static public void main(String args[]) {
        PApplet.main(new String[]{IncrementingSpheres.class.getName()});
    }
    ...
    public void draw() {
        ...
        fill(255);
        stroke(255);
        text(String.format("FPS: %.3f, sphr: %d", currentFps, elementCount) ,10,100);
    }
}
